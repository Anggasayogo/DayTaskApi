...
var _apiError = _interopRequireDefault(require("../errors/api-error.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
/**
 * Error handler. Send stacktrace only during development
 * @public
 */
var handler = exports.handler = function handler(err, req, res, next) {
  var response = {
    code: err.status,
 ...
 * @public
 */
var converter = exports.converter = function converter(err, req, res, next) {
