...
var getUsersList = exports.getUsersList = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _UsersModel["default"].findAll({
            attributes: [["id", "user_id"], ["username", "username"], ["email", "email"], ["phone", "phone"], ["avatar", "avatar"]]
          });
        case 3:
          user = _context3.sent;
          res.send(user);
      ...
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          try {
            ...
            timeFormat = 'YYYY-MM-DD HH:mm:ss'; // Example format
            currentTime = (0, _momentTimezone["default"])().tz(timezone[2].zone_code).format(timeFormat);
            res.status(200).send({
