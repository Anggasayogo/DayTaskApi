...
exports.updateTask = exports.getTaskListByUserId = exports.getTaskList = exports.getTaskById = exports.destroyTask = exports.createNassignTask = void 0;
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Import model Product
// Get semua product
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _database["default"].query((0, _rawQuery.getTaskByUserId)(req.params.id), {
            type: _sequelize.QueryTypes.SELECT
          });
        case 3:
